...
import com.wei.example.web.LandingBootApplication;
...
public class GreetRest {
    ...
    public void greet(){
        logger.info("[Rest API] called: '/greet'");
        Map<String , String> msg = new HashMap<>();
        msg.put("greeting", "say hello");
        msg.put("lang", "english");
        this.jmsTemplate.convertAndSend(LandingBootApplication.QueueName, msg);
    }
}
